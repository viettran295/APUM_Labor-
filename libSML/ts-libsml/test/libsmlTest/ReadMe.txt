========================================================================
    KONSOLENANWENDUNG: libsmlTest-Projektübersicht
========================================================================

Diese libsmlTest-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre libsmlTest-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "libsmlTest.pch und eine 
