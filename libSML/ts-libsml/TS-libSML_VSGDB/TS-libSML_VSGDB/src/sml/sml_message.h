...
// we also should think about the additional tranport encoding which leads to about 32 additional bytes

#define SML_FILE_BUFFER_ADDITIONAL_LENGTH 32
#define SML_FILE_BUFFER_MESSAGE_LENGTH 1024

#define SML_FILE_BUFFER_LENGTH SML_FILE_BUFFER_MESSAGE_LENGTH + SML_FILE_BUFFER_ADDITIONAL_LENGTH
